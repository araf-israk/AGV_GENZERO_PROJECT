...
#define TURN_LED_RED_Pin GPIO_PIN_9
#define TURN_LED_RED_GPIO_Port GPIOD
#define TURN_LED_GREEN_Pin GPIO_PIN_10
#define TURN_LED_GREEN_GPIO_Port GPIOD
#define ORIENTATION_LED_RED_Pin GPIO_PIN_11
#define ORIENTATION_LED_RED_GPIO_Port GPIOD
#define ORIENTATION_LED_GREEN_Pin GPIO_PIN_12
#define ORIENTATION_LED_GREEN_GPIO_Port GPIOD
#define ONTASK_LED_RED_Pin GPIO_PIN_14
#define ONTASK_LED_RED_GPIO_Port GPIOD
#define ONTASK_LED_GREEN_Pin GPIO_PIN_15
#define ONTASK_LED_GREEN_GPIO_Port GPIOD
